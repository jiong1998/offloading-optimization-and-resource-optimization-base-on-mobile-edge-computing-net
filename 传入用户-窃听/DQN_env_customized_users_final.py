...
for epoch in range(epochs):
    ...
    while True:  # 每次循环执行一个动作
        ...
        # 执行，获得环境反馈
        s_, r, done, tc_wald, local_cost = env_tradition.step(action)
...
# Writedata.write_to_excel(epoch_cost_optimize,1,"epoch_cost_optimize_E25_1")
# Writedata.write_to_excel(epoch_cost_tradition,1,"epoch_cost_tradition_E25_1")
# Writedata.write_to_excel(local_costs_epoch,1,"local_costs_epoch_E25_1")

plt.xlabel("epoch_e25")
plt.ylabel("costs")
plt.legend(loc="best")
plt.show()
